...
export const sceneHotspots: HotspotData[] = [
  ...
  { id: "apparatus2", label: "Apparatus (Right)", desc: "Noise, vehicle movement, and backing hazards. Stay clear of apparatus blind spots and always use a spotter when backing.", x: 75, y: 30, w: 23, h: 55 },
...
export const ppeHotspots: HotspotData[] = [
  ...
  { id: "scba-cylinder", label: "SCBA Cylinder", desc: "SCBA in good, working order. Cylinder is within hydrostatic test date. Check air pressure is at minimum 90% capacity before use.", x: 55, y: 25, w: 30, h: 22 },
